                    ...
                    <Navbar.Collapse className="justify-content-between">
                        ...
                        <Nav className="mr-auto">
                            {hasRole(currentUser, "ROLE_USER") && (
                                <NavDropdown
                                    title="Songs"
                                    id="appnavbar-songs-dropdown"
                                    data-testid="appnavbar-songs-dropdown"
                                >
                                    <NavDropdown.Item
                                        href="/songs/list"
                                        data-testid="appnavbar-songs-list"
                                    >
                                        List
                                    </NavDropdown.Item>
                                    {hasRole(currentUser, "ROLE_ADMIN") && (
                                        <NavDropdown.Item
                                            href="/songs/create"
                                            data-testid="appnavbar-songs-create"
                                        >
                                            Create
                                        </NavDropdown.Item>
                                    )}
                        ...
                        <Nav className="mr-auto">
                            {hasRole(currentUser, "ROLE_USER") && (
                                <NavDropdown
                                    title="Restaurants"
                                    id="appnavbar-restaurants-dropdown"
                                    data-testid="appnavbar-restaurants-dropdown"
                                >
                                    <NavDropdown.Item
                                        href="/restaurants/list"
                                        data-testid="appnavbar-restaurants-list"
                                    >
                                        List
                                    </NavDropdown.Item>
                                    {hasRole(currentUser, "ROLE_ADMIN") && (
                                        <NavDropdown.Item
                                            ...
                                            data-testid="appnavbar-restaurants-create"
                                        >
                                            Create
                                        </NavDropdown.Item>
                                    )}
                        ...
                        <Nav className="mr-auto">
                            {hasRole(currentUser, "ROLE_USER") && (
                                <NavDropdown
                                    title="Movies"
                                    id="appnavbar-movies-dropdown"
                                    data-testid="appnavbar-movies-dropdown"
                                >
                                    <NavDropdown.Item
                                        href="/movies/list"
                                        data-testid="appnavbar-movies-list"
                                    >
                                        List
                                    </NavDropdown.Item>
                                    {hasRole(currentUser, "ROLE_ADMIN") && (
                                        <NavDropdown.Item
                                            href="/movies/create"
                                            data-testid="appnavbar-movies-create"
                                        >
                                            Create
                                        </NavDropdown.Item>
                                    )}
