        ...
        <Container>
          ...
          <Navbar.Collapse className="justify-content-between">
            ...
            <Nav className="mr-auto">
              {
                hasRole(currentUser, "ROLE_USER") && (
                  <NavDropdown title="Songs" id="appnavbar-songs-dropdown" data-testid="appnavbar-songs-dropdown" >
                    <NavDropdown.Item href="/songs/list" data-testid="appnavbar-songs-list">List</NavDropdown.Item>
                    {
                      hasRole(currentUser, "ROLE_ADMIN") && (
                        <NavDropdown.Item href="/songs/create" data-testid="appnavbar-songs-create">Create</NavDropdown.Item>
                      )
                    }
                  </NavDropdown>
                )
