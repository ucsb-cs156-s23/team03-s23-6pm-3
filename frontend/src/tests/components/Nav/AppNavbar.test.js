...
describe("AppNavbar tests", () => {
    ...
    test("renders the songs menu correctly for a user", async () => {
        const currentUser = currentUserFixtures.userOnly;
        const systemInfo = systemInfoFixtures.showingBoth;
        ...
        await findByTestId("appnavbar-songs-dropdown");
        const dropdown = getByTestId("appnavbar-songs-dropdown");
        const aElement = dropdown.querySelector("a");
        expect(aElement).toBeInTheDocument();
        aElement?.click();
        await findByTestId("appnavbar-songs-list");
    });

    test("renders the songs menu correctly for an admin", async () => {
        const currentUser = currentUserFixtures.adminUser;
        const systemInfo = systemInfoFixtures.showingBoth;
        ...
        expect(aElement).toBeInTheDocument();
        aElement?.click();
        await findByTestId(/appnavbar-songs-create/);
    });
    ...
    test("renders the movies menu correctly for a user", async () => {
        const currentUser = currentUserFixtures.userOnly;
        const systemInfo = systemInfoFixtures.showingBoth;
        ...
        await findByTestId("appnavbar-movies-dropdown");
        const dropdown = getByTestId("appnavbar-movies-dropdown");
        const aElement = dropdown.querySelector("a");
        expect(aElement).toBeInTheDocument();
        aElement?.click();
        await findByTestId("appnavbar-movies-list");
    });

    test("renders the movies menu correctly for an admin", async () => {
        const currentUser = currentUserFixtures.adminUser;
        const systemInfo = systemInfoFixtures.showingBoth;
        ...
        expect(aElement).toBeInTheDocument();
        aElement?.click();
        await findByTestId(/appnavbar-movies-create/);
    });
});
